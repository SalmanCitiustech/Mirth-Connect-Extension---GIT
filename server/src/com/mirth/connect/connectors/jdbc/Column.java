...
public class Column implements Serializable {
	 ...
	 * @param type A SQL type name
	 * @param precision Precision for the type (eg. the length for numeric, or characters for string)
	 */
	...
	/**
	 * @param type The SQL type name {@link Types}
	 */
	...
	public boolean equals(Object obj) {
		...
		if (name != null && !name.equals(col.getName())) return false;
		if (type != null && !type.equals(col.getType())) return false;
		if (precision != col.getPrecision()) return false;
